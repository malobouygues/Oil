...
from src.curves import load_oil_data, get_current_curve, calculate_roll_yield
from data.CL_futures_dwnld import download_oil_data
...
print("Mise à jour des données de futures pétroliers...")
download_oil_data()
...
if df_oil is None or len(df_oil) == 0:
    ...
    if current_curve is not None and len(current_curve) > 0:
        ...
        if roll_yield is not None and len(roll_yield) > 0:
            ...
            ax2.set_ylabel('Roll Yield (%)', fontsize=10)
